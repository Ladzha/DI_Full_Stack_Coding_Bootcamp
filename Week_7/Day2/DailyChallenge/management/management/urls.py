...
from managapp.views import DepartmentListAPIView, DepartmentCreateAPIView, DepartmentRetrieveAPIView,EmployeeListAPIView, EmployeeCreateAPIView, EmployeeRetrieveAPIView, ProjectListAPIView, ProjectRetrieveAPIView, ProjectUpdateAPIView, ProjectDestroyAPIView, TaskListAPIView, TaskRetrieveAPIView, TaskUpdateAPIView, TaskDestroyAPIView
...
urlpatterns = [
    ...
    path('api/departmentdetail/<int:pk>/', DepartmentRetrieveAPIView.as_view(), name='department-detail'),
    ...
    path('api/employeetdetail/<int:pk>/', EmployeeRetrieveAPIView.as_view(), name='employee-detail'),
    ...
    path('api/taskdelete/<int:pk>/', TaskDestroyAPIView.as_view(), name='task-delete'),
    ...
    path('api/projectdelete/<int:pk>/', ProjectDestroyAPIView.as_view(), name='project-delete'),
]
